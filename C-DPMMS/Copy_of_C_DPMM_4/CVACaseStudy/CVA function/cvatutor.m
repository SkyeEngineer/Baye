function [T2mon,Qmon,Ta,Qa]=cvatutor(a,n,p,f,X1,X2,Xt)
...
Rp = chol(Yp*Yp'/(pn));            %Past Cholesky matrix
Rf = chol(Yf*Yf'/(pn));              %Future Cholesky matrix
Hfp = Yf*Yp'/pn;                     %Cross-covariance matrix
H = (Rf'\Hfp)/Rp;                    %Hankel matrix
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % Sigmaff=Yf*Yf'/(pn);Sigmapp=Yp*Yp'/(pn);Sigmafp=Yf*Yp'/(pn);
% % H1=Sigmaff\Sigmafp/Sigmapp;
% % [~,S1,v1] = svd(H1); 
% % J1=v1';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
