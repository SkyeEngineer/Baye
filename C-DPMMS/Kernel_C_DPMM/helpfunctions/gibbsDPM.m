function [partition_samples, partition_estimate, similarity,p_mu,p_sig,p_isig,ind1,cluster_size] = gibbsDPM(Data,da,dw,y, hyperG0, alpha, niter, type_algo, doPlot)
...
switch(type_algo)
    ...
    case 'CRP' % Based on the Chinese Restaurant Process
        [partition_samples, MU, SIG, iSIG] = gibbsDPM_algo2(Data,da,dw,y,hyperG0, alpha, niter, doPlot);
